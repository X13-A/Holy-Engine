...
SRC = $(CAMERA_SRC) $(COMMON_SRC) $(CONTROLS_SRC) $(GEOMETRY_SRC) $(GRID_SRC) $(GUI_SRC) $(IMGUI_SRC) $(IMGUI_BACKEND_SRC) $(INPUT_SRC) $(LIGHT_SRC) $(MATERIALS_SRC) $(MATH_SRC) $(MODEL_SRC) $(UTILS_SRC) $(WINDOW_SRC) $(MAIN_SRC)
